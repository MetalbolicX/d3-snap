import { D3Node } from "../src/index.ts";

// Example 1: Create a simple SVG with a circle
const node1 = new D3Node();
...
const node3 = new D3Node({ container: "<div id='chart'></div>", selector: "#chart" });
...
const node4 = new D3Node({ container: "<section><svg></svg></section>", selector: "svg" });
